...
<img src="_class-renders/druid.png" width="170" align="right" alt="Druid">

| | |
|---|---|
| **Resource** | Mana |
| **Roles** | Tank, Healer, DPS |
| **Specs** | Moongrove (DPS) · Wildfang (Tank) · Groveheart (Healer) |
...
42 abilities, in the order you learn them. "Ranks" shows the levels where the ability gets stronger.

| Ability | Learns at (lvl) | Cost | Cast | Cooldown | Range | School | Effect |
|---|---|---:|---|---|---:|---|---|
| Wildbolt | 1 _(ranks: 8, 14, 20)_ | 20 | 1.5s | — | 30 | Nature | Hurls a bolt of nature energy for X Nature damage. |
| Wildmend | 1 _(ranks: 8, 14, 20)_ | 25 | 2.5s | — | 30 | Nature | Heals a friendly target for X. |
| Wildward | 1 | 20 | Instant | — | 30 | Nature | Places the Wildward on the party, increasing all attributes of all party members by X% for 30 min. |
| Lunar Tempest | 4 _(ranks: 10, 16)_ | 25 | Instant | — | 30 | Arcane | Burns the enemy with moonfire for X Arcane damage plus damage over time. |
| Wildbloom | 4 _(ranks: 10, 16, 20)_ | 25 | Instant | — | 30 | Nature | Heals the target for X over 12 sec. |
| Claw | 5 _(ranks: 18)_ | 45 | Instant | — | Melee | Physical | Claw the enemy for weapon damage plus X. Awards 1 combo point. Wolf Form only. |
| Flense | 5 _(ranks: 18)_ | 35 | Instant | — | Melee | Physical | A stealth opener that rakes the enemy for weapon damage plus X and causes bleeding damage over 9 sec. Awards 1 combo point. Wolf Form only. |
...
| Bonecrush | 10 _(ranks: 16)_ | 15 | Instant | — | Melee | Physical | A mauling attack that increases melee damage by X and causes a high amount of threat. Activates on your next swing. Bruin Form only. |
| Bruin Rush | 10 | — | Instant | 15s | 25 | Physical | Rush an enemy, generating 9 rage and stunning it for 1 sec. 8-25 yd range. Bruin Form only. |
...
| Gladesong | 10 | 120 | Instant | 5 min | Melee | Nature | Channels restorative energy for 4 sec, healing allies within 30 yd for 42 to 52 each second. (Druid talent) |
| Headbutt | 10 | 10 | Instant | 15s | 8 | Physical | Interrupts spellcasting and prevents any spell in that school from being cast for 4 sec. (Druid talent) |
| Lifesap | 10 | — | Instant | 1.5 min | Melee | Nature | Living sap wells up in you for 10 sec, restoring 20 of your current resource in waves: mana, Rage, or Energy, and shifting forms does not break it. Sleep, stun, or stasis stills the sap. (Druid talent) |
| Menace | 10 | — | Instant | 10s | 8 | Physical | Menaces the target: your threat rises to match its most hated enemy and it is compelled to attack you for 3 sec. Bruin Form only. |
...
| Red Haze | 10 | — | Instant | 3 min | Melee | Physical | Increases attack power by 70 for 15 sec. (Druid talent) |
| Savage Mending | 10 | 10 | Instant | 1 min | Melee | Nature | Restores 180 health over 10 sec. Bruin Form only. (Druid talent) |
...
| Sweeping Claws | 16 | 20 | Instant | — | Melee | Physical | Sweep your claws through nearby enemies for X damage. Causes extra threat. Bruin Form only. |
| Dash | 18 | — | Instant | 1 min | Melee | Physical | Sprint forward, increasing movement speed by 50% for 15 sec. Wolf Form only. |
| Galeheart | 18 | 90 | Instant | 12s | 30 | Nature | Calls a hurricane onto the target area for 6 sec, battering enemies for X Nature damage each second. |
...
| Wolfsblood | 20 | 30 | Instant | 30s | Melee | Physical | Increases attack power by X for X sec. Wolf Form only. |
