...
| Concuss | 16 | 10 | Instant | 1 min | 8 | Physical | Stuns the target for 2 sec. Bruin Form only. |
| Fleet Form | 16 | 30 | Instant | — | Melee | Nature | Instantly shift into a swift travel form, increasing movement speed by 40%. You cannot use other abilities while shifted, but can shift in or out of combat, ideal for escaping. |
...
| Sweeping Claws | 16 | 20 | Instant | — | Melee | Physical | Swipe nearby enemies for X damage. Causes extra threat. Bruin Form only. |
| Dash | 18 | — | Instant | 1 min | Melee | Physical | Sprint forward, increasing movement speed by 50% for 15 sec. Wolf Form only. |
| Hurricane | 18 | 90 | Instant | 12s | 30 | Nature | Calls a hurricane onto the target area for 6 sec, battering enemies for X Nature damage each second. |
| Skyfall | 18 | 80 | 3s | — | 30 | Arcane | Calls down a bolt of stellar fire, causing X Arcane damage. |
