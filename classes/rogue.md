...
| **Resource** | Energy |
| **Roles** | DPS |
| **Specs** | Assassination (DPS) · Combat (DPS) · Subtlety (DPS) |

## Specializations

- **Assassination** — _DPS_. Signature ability: **Eviscerate** (learned at level 1).
- **Combat** — _DPS_. Signature ability: **Adrenaline Rush** (learned at level 20).
- **Subtlety** — _DPS_. Signature ability: **Ambush** (learned at level 16).
...
| Evasion | 8 | — | Instant | 5 min | Melee | Physical | Increases your dodge chance by 50% for 15 sec. |
...
| Slice and Dice | 10 | 25 | Instant | — | Melee | Physical | Finishing move that increases melee attack speed by 30%. Lasts longer per combo point. |
| Sprint | 10 | — | Instant | 5 min | Melee | Physical | Increases your movement speed by 70% for 15 sec. |
| Crippling Poison | 12 | 40 | Instant | — | Melee | Nature | Strikes the target with a crippling poison, dealing {damage} Nature damage and slowing its movement speed by 50% for 12 sec. |
| Expose Armor | 14 | 25 | Instant | — | Melee | Physical | Finishing move that exposes the target, reducing its armor. More combo points spent build into a deeper cut. |
| Kidney Shot | 14 | 25 | Instant | 20s | Melee | Physical | Finishing move that stuns the target. Lasts 1 sec longer per combo point. |
