...
| **Resource** | Mana |
| **Roles** | DPS |
| **Specs** | Aethermancy (DPS) · Pyromancy (DPS) · Cryomancy (DPS) |
...
|---|---|---:|---|---|---:|---|---|
| Aether Insight | 1 | 25 | Instant | — | Melee | Arcane | Increases the Intellect of all party members by X% for 30 min. |
...
| Waterbind | 4 _(ranks: 10, 16)_ | 40 | 3s | — | Melee | Arcane | Conjures 2 bottles of water, restoring mana when drunk. Higher ranks conjure purer water. |
| Breadbind | 6 _(ranks: 12, 18)_ | 45 | 3s | — | Melee | Arcane | Conjures 2 servings of bread, restoring health when eaten. Higher ranks conjure heartier fare. |
...
| Frostveil | 20 | 90 | Instant | 30s | Melee | Frost | Shields you in ice, absorbing X damage for 60 sec. |
| Pyrelance | 20 | 125 | 6s | — | 30 | Fire | Hurls an immense fiery boulder that causes X Fire damage plus additional damage over time. |
