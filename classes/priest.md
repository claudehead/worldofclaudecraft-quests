...
<img src="_class-renders/priest.png" width="170" align="right" alt="Priest">

| | |
|---|---|
| **Resource** | Mana |
| **Roles** | Healer, DPS |
| **Specs** | Discipline (Healer) · Holy (Healer) · Shadow (DPS) |

## Specializations

- **Discipline** — _Healer_. Signature ability: **Power Word: Shield** (learned at level 6).
- **Holy** — _Healer_. Signature ability: **Flash Heal** (learned at level 20).
- **Shadow** — _DPS_. Signature ability: **Mind Flay** (learned at level 16).
...
|---|---|---:|---|---|---:|---|---|
| Lesser Heal | 1 _(ranks: 6, 12)_ | 30 | 2s | — | 30 | Holy | Heals a friendly target for X. |
| Power Word: Fortitude | 1 _(ranks: 12, 20)_ | 30 | Instant | — | 30 | Holy | Increases the target's Stamina by 3 for 30 min. |
| Smite | 1 _(ranks: 8, 14, 20)_ | 20 | 2s | — | 30 | Holy | Smites the enemy for X Holy damage. |
| Shadow Word: Pain | 4 _(ranks: 10, 16)_ | 25 | Instant | — | 30 | Shadow | A word of darkness causes X Shadow damage over 18 sec. |
| Power Word: Shield | 6 _(ranks: 12, 18)_ | 45 | Instant | 6s | 30 | Holy | Shields the target, absorbing 48 damage for 30 sec. |
