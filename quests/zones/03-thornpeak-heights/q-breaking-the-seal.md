...
> Quest ID: `q_breaking_the_seal` · Zone 3 — Thornpeak Heights
...
- The Voice Below (`q_voice_below`)

## Where to go

![Where to go for Breaking the Seal](qmap-q-breaking-the-seal.svg)

**[🧭 Open this route in 3D →](#/questroute/q_breaking_the_seal)**
