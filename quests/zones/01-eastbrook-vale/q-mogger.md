...
> Mogger has split carts, flattened fences, and killed enough livestock to empty half the Vale. Do not face him alone. Take two strong companions into the western meadow and put the brute down for good.
...
- **Item reward (by class):**
  - <img src="../_loot-icons/bristleback_maul.png" width="20" alt=""> 🟢 Gallowglass Hammer — _warrior_ · 7–12 dmg @ 2.8s (~3 DPS), +2 Str, +1 Sta
...
![Where to go for Mogger Must Fall](qmap-q-mogger.svg)

**[🧭 Open this route in 3D →](#/questroute/q_mogger)**
