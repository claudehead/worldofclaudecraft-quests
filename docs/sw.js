...
const CACHE = 'woc-v152';
const SHELL_FILES = ['./', 'index.html', 'app.js?v=137', 'styles.css?v=116', 'manifest.webmanifest', 'icon-192.png', 'icon-512.png', 'wireframe/', 'wireframe/index.html', 'platformer/', 'platformer/index.html'];
