...
const CACHE = 'woc-v158';
const SHELL_FILES = ['./', 'index.html', 'app.js?v=140', 'styles.css?v=117', 'manifest.webmanifest', 'icon-192.png', 'icon-512.png', 'wireframe/', 'wireframe/index.html', 'platformer/', 'platformer/index.html'];
