...
const SECTIONS = [
  ...
  ['news', "What's New", "What's new in World of Claudecraft v0.32 and in the field guide — Rifts (the procedural endgame race), the new expansion zones, rideable mounts, and the guide's new tools and games."],
