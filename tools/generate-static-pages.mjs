...
const SECTIONS = [
  ...
  ['news', "What's New", "What's new in World of Claudecraft v0.28 and in the field guide — the professions and crafting overhaul, the choice-row talent rework, the Card Duel minigame, and the guide's new tools and games."],
