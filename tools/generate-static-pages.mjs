...
const SECTIONS = [
  ...
  ['news', "What's New", "What's new in World of Claudecraft v0.31 and in the field guide — the parkour physics engine, hand-painted item art, Auction House filters, enchant replacement, and the guide's new tools and games."],
