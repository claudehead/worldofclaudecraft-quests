...
_As of 2026-06-29 · 98 branches in flight._

## 🟢 Fresh — actively in progress (updated this week)

| What | Type | Last update | PR |
|---|---|---|---|
| two-way Discord integration (login, rewards, bot, relay, in-game flair) | ✨ Feature | today | [#1044](https://github.com/levy-street/world-of-claudecraft/pull/1044) |
| satisfy changed-file biome | ✨ Feature | today | — |
...
| tune fast rare drops and market mech plates | 🔧 Fix | 9 days ago | [#756](https://github.com/levy-street/world-of-claudecraft/pull/756) _(draft)_ |
| retire Aldric fallen star quest | 🔧 Fix | 9 days ago | — |
| record the pure-core + thin-consumer extraction pattern | 🔧 Fix | 9 days ago | — |
| refine Wallet Standard UX and i18n | 🔧 Fix | 9 days ago | — |
| align market catalog locale shape | 🔧 Fix | 9 days ago | — |
| apply final dot ticks | • | 9 days ago | — |
...
| return tradable mech cosmetic on unequip | 🔧 Fix | 10 days ago | — |
| add mobile input zoom regression check | 🔧 Fix | 10 days ago | — |
| guard character saves during relog | 🔧 Fix | 10 days ago | — |
| revert(arena): remove 2v2 fiesta from v0.10 | 🔧 Fix | 10 days ago | — |
| ci: restore release gate | 🔧 Fix | 10 days ago | — |
...
| merge: re-integrate onto advanced release/v0.9 (b5124f8); regenerate i18n | • | 11 days ago | — |
| Merged main in | • | 11 days ago | — |
...
| reverse Ghost Wolf backpedal animation | 🔧 Fix | 12 days ago | — |
| allow two active account sessions | 🔧 Fix | 12 days ago | — |
| remove i18n-scaling planning scaffolding | 🛠 Refactor | 12 days ago | — |
| keep space as gameplay input | 🔧 Fix | 12 days ago | — |
| Revert "feat(items): Inventory 2.0 — 4 equipment slots + 11 items" | ✨ Feature | 12 days ago | — |
| translate /links page into all supported locales | ⚙️ Chore | 13 days ago | — |
| add chroma selection previews | • | 13 days ago | [#403](https://github.com/levy-street/world-of-claudecraft/pull/403) _(draft)_ |
| MediaWiki fandom community site | • | 13 days ago | — |
| populate class trees and polish nodes | • | 14 days ago | — |
