...
| <a id="item-iron_mining_pick"></a>Iron Mining Pick | vendor (Trader Wilkes) | tool |
| <a id="item-ironbark_axe"></a>Ironbark Axe | vendor (Trader Wilkes) | tool |
| <a id="item-ivory_copper_armor_plate"></a>Ivory Copper | — | tool |
| <a id="item-magenta_cyan_armor_plate"></a>Magenta Cyan | — | tool |
| <a id="item-mithril_mining_pick"></a>Mithril Mining Pick | vendor (Trader Wilkes) | tool |
...
| <a id="item-simple_fishing_pole"></a>Simple Fishing Pole | vendor (Fisherman Brandt, Provisioner Hale, Quartermaster Bree) | tool |
