...
| <a id="item-ridge_stalker_pelt"></a>Ridge Stalker Pelt | [Ridge Stalker](../quests/zones/03-thornpeak-heights/bestiary.md#mob-ridge_stalker) 60% | Quest: [Winter Is Coming to Highwatch](../quests/zones/03-thornpeak-heights/q-stalker-pelts.md), [Cloaks for the Watch](../quests/zones/03-thornpeak-heights/q-stalker-cloaks.md) |
...
| <a id="item-bronze_sickle"></a>Bronze Sickle | vendor (Trader Wilkes, Tinker Gizzel) | tool |
| <a id="item-copper_mining_pick"></a>Copper Mining Pick | vendor (Trader Wilkes, Forgemistress Darva) | tool |
...
| <a id="item-felling_axe"></a>Felling Axe | vendor (Trader Wilkes, Tinker Gizzel) | tool |
| <a id="item-forest_pink_armor_plate"></a>Forest Pink | — | tool |
| <a id="item-gathering_sickle"></a>Gathering Sickle | vendor (Trader Wilkes, Weaver Ottilie) | tool |
| <a id="item-goldleaf_sickle"></a>Goldleaf Sickle | — | tool |
| <a id="item-handaxe"></a>Handaxe | vendor (Trader Wilkes, Tinker Gizzel) | tool |
...
| <a id="item-iron_mining_pick"></a>Iron Mining Pick | vendor (Trader Wilkes, Forgemistress Darva) | tool |
| <a id="item-ironbark_axe"></a>Ironbark Axe | vendor (Trader Wilkes, Tinker Gizzel) | tool |
| <a id="item-ivory_copper_armor_plate"></a>Ivory Copper | — | tool |
| <a id="item-magenta_cyan_armor_plate"></a>Magenta Cyan | — | tool |
| <a id="item-mithril_mining_pick"></a>Mithril Mining Pick | vendor (Trader Wilkes, Forgemistress Darva) | tool |
...
| <a id="item-silverleaf_sickle"></a>Silverleaf Sickle | vendor (Trader Wilkes, Tinker Gizzel) | tool |
...
| <a id="item-arcanite_bar"></a>Arcanite Bar | vendor (Tinker Gizzel, Quartermaster Bree) | sells for 40c |
...
| <a id="item-copper_ore"></a>Copper Ore | — | sells for 4c |
...
| <a id="item-elderwood_log"></a>Elderwood Log | vendor (Tinker Gizzel, Quartermaster Bree) | sells for 40c |
...
| <a id="item-game_meat"></a>Game Meat | — | sells for 4c |
| <a id="item-glass_vial"></a>Glass Vial | vendor (Alchemist Verane) | sells for 3c |
| <a id="item-goldleaf_herb"></a>Goldleaf Herb | vendor (Tinker Gizzel, Quartermaster Bree) | sells for 15c |
...
| <a id="item-ironbark_log"></a>Ironbark Log | — | sells for 4c |
...
| <a id="item-rough_hide"></a>Rough Hide | — | sells for 5c |
| <a id="item-silverleaf_herb"></a>Silverleaf Herb | — | sells for 4c |
...
| <a id="item-spider_silk"></a>Spider Silk | — | sells for 5c |
...
| <a id="item-thorium_ore"></a>Thorium Ore | vendor (Forgemistress Darva, Weaver Ottilie, Tinker Gizzel, Tanner Hesk, Quartermaster Bree) | sells for 15c |
